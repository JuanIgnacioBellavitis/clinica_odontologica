...
public class PacienteDAOH2 implements IDAO<Paciente> {
    ...
    public Paciente guardar(Paciente paciente) {
        ...
        try {
            ...
            Domicilio domicilioGuardado = domicilioDAOH2.guardar(paciente.getDomicilio());
            ...
            ps.setInt(5, domicilioGuardado.getId());
    ...
    public Paciente modificar(Paciente paciente) {
        ...
        try {
            ...
            // 🔹 Primero guardar el nuevo domicilio (siempre crea uno nuevo)
            Domicilio domicilioGuardado = domicilioDAOH2.modificar(paciente.getDomicilio());

            // 🔹 Luego actualizar el paciente con el nuevo domicilio_id
    ...
    private Paciente mapearPaciente(ResultSet rs) throws SQLException {
        ...
        Domicilio domicilio = domicilioDAO.buscar(rs.getInt("DOMICILIO_ID")); // ✅ buscamos domicilio por ID
