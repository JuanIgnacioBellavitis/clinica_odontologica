...
public class OdontologoService implements IOdontologoService {
	...
	public OdontologoDTO buscarOdontologoPorNombre(String nombre) {
		...
		Odontologo odontologo = odontologoRepository.findByNombre(nombre)
				.orElseThrow(() -> new NotFoundException("No se encontró odontologo con el nombre " + nombre));
	...
	public String eliminarOdontologo(Long id) {
		Odontologo odontologo = odontologoRepository.findById(id)
				.orElseThrow(() -> new NotFoundException("No se encontró el odontologo con ID " + id));
	...
	public OdontologoDTO editarOdontologos(Long id, OdontologoDTO odontologoDTO) {
		Odontologo odontologoExistente = odontologoRepository.findById(id).orElseThrow(
				() -> new NotFoundException("No se encontró el odontologo con ID " + odontologoDTO.getId()));
