...
import java.util.Optional;
    ...
    public class UsuarioService implements UserDetailsService {
        ...
        @Autowired
        public UsuarioService( UsuarioRepository usuarioRepository, ObjectMapper mapper, BCryptPasswordEncoder passwordEncoder ) {
        ...
        public Usuario registrarNuevoUsuario(String nombre, String apellido, String userName, String email, String password) {
